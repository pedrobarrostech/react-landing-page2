    ...
    <div id='index-banner' className='parallax-container'>
      <div className='section no-pad-bot main-banner'>
        <div className='container'>
          <br/><br/>
          <h1 className='header center red-text text-darken-3'>Parallax Template</h1>
          <div className='row center'>
            <h5 className='header col s12 light'>A modern responsive front-end framework based on Material Design</h5>
          </div>
          <div className='row center'>
            <a href='http://materializecss.com/getting-started.html' id='download-button' className='btn-large waves-effect waves-light red darken-3'>Get Started</a>
          </div>
          <br/><br/>
